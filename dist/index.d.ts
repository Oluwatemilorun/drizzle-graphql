import { Table, Column, Relations, Relation, One, Many, TablesRelationalConfig, TableRelationalConfig } from 'drizzle-orm';
...
import { RelationalQueryBuilder as RelationalQueryBuilder$2 } from 'drizzle-orm/sqlite-core/query-builders/query';
import { GraphQLSchema, GraphQLInputObjectType, GraphQLObjectType, GraphQLNonNull, GraphQLList, GraphQLScalarType, GraphQLResolveInfo, GraphQLEnumType } from 'graphql';
...
type AnyDrizzleDB<TSchema extends Record<string, any>> = PgDatabase<any, TSchema> | BaseSQLiteDatabase<any, any, TSchema> | MySqlDatabase<any, any, TSchema>;
type AnyQueryBuiler<TConfig extends TablesRelationalConfig = any, TFields extends TableRelationalConfig = any> = RelationalQueryBuilder<TConfig, TFields> | RelationalQueryBuilder$1<any, TConfig, TFields> | RelationalQueryBuilder$2<any, any, TConfig, TFields>;
...
export { type AnyDrizzleDB, type AnyQueryBuiler, type BuildSchemaConfig, type DeleteArgs, type DeleteResolver, type ExtractRelations, type ExtractTableByName, type ExtractTableRelations, type ExtractTables, type GeneratedData, type GeneratedEntities, type GeneratedInputs, type GeneratedOutputs, type InsertArgs, type InsertArrResolver, type InsertResolver, type MutationReturnlessResult, type MutationsCore, type QueriesCore, type QueryArgs, type SelectResolver, type SelectSingleResolver, type UpdateArgs, type UpdateResolver, buildSchema };
